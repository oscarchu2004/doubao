...
const MapDetailsForm = ({ onClose, onSave, isEdit = false, existingMap = null }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (error.response) {
                setErrorMessage(error.response.data.error || 'Failed to create space')
            } else {
                    ...
                    <div className='col-md-6 right-box'>
                        <div className='row align-items-left'>
                            <div className='header-text mb-4 text-start'>
                                <h1>Create Space</h1>
                                <p>Enter details for your virtual tour space</p>
                            </div>
                            ...
                            <form onSubmit={handleSubmit}>
                                ...
                                {/* Minimap Upload */}
                                <div className='mb-3'>
                                    <label className='form-label' style={{ textAlign: 'left', color: '#6c757d' }}>Minimap (Floor Plan) Image</label>
                                    <input
                                        type='file'
                                        accept='image/*'
